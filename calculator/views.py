...
def calculate_salary(data):
    ...
    if sni <= 2500:
        taux, somme_deduire = 0, 0
    elif sni <= 4166:
        taux, somme_deduire = 0.10, 250
    elif sni <= 5000:
        taux, somme_deduire = 0.20, 666.67
    elif sni <= 6666:
        taux, somme_deduire = 0.30, 1166.67
    elif sni <= 15000:
        taux, somme_deduire = 0.34, 1433.33
    else:
        taux, somme_deduire = 0.38, 2033
    
    ir_brut = max(0, sni * taux - somme_deduire)
    
    # Family charges
    charge_famille = min(nb_charge_familiale, 6) * 30
